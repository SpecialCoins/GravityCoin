...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            case SPORK_1_VERSION_ON:                        r = SPORK_1_VERSION_ON_DEFAULT; break;
            ...
            case SPORK_9_SIGMA_NEW:                         r = SPORK_9_SIGMA_NEW_DEFAULT; break;
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        case SPORK_1_VERSION_ON:                        return SPORK_1_VERSION_ON_DEFAULT;
        ...
        case SPORK_9_SIGMA_NEW:                         return SPORK_9_SIGMA_NEW_DEFAULT;
...
{
    if (strName == "SPORK_1_VERSION_ON")                    return SPORK_1_VERSION_ON;
    ...
    if (strName == "SPORK_9_SIGMA_NEW")                     return SPORK_9_SIGMA_NEW;
...
{
    switch (nSporkID) {
        case SPORK_1_VERSION_ON:                        return "SPORK_1_VERSION_ON";
        ...
        case SPORK_9_SIGMA_NEW:                         return "SPORK_9_SIGMA_NEW";
