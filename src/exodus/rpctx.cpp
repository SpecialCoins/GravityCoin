...
UniValue exodus_sendrawtx(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            ...
            "5. referenceamount      (string, optional) a gravitycoin amount that is sent to the receiver (minimal by default)\n"
            "\nResult:\n"
...
UniValue exodus_send(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 4 || params.size() > 6)
        throw runtime_error(
            ...
            "6. referenceamount      (string, optional) a gravitycoin amount that is sent to the receiver (minimal by default)\n"
...
UniValue exodus_sendspend(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 3 || params.size() > 4) {
        throw std::runtime_error(
            ...
            "4. referenceamount              (string, optional) a gravitycoin amount that is sent to the receiver (minimal by default)\n"
            "\nResult:\n"
            "\"hash\"                          (string) the hex-encoded transaction hash\n"
            "\nExamples:\n"
